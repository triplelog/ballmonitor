(function (root, factory) {
  ...
  function Sparkbar(element, options) {
    this.element = element;
    this.options = extend(options || {}, Sparkbar.options);
  ...
  Sparkbar.init = function (element, options) {
    return new Sparkbar(element, options);
  };

  Sparkbar.draw = function (element, points, options) {
    var sparkbar = new Sparkbar(element, options);
    sparkbar.draw(points);
    return sparkbar;
  }
  ...
  Sparkbar.prototype.draw = function (points) {
