...
class TabDNBox extends TabDN {
	...
	constructor() {
		...
		this.shadowRoot.querySelector("#team1").addEventListener("change", e => {this.chgTeam(e)});
		this.shadowRoot.querySelector("#team2").addEventListener("change", e => {this.chgTeam(e)});
