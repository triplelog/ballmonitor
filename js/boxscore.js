...
class TabDNBox extends TabDN {
	...
	constructor() {
		...
		this.shadowRoot.querySelector("#team1").addEventListener("input", e => {this.chgTeam()});
		...
		var input2 = this.shadowRoot.querySelector("#team2");
		new Awesomplete(input1, {list: [{"label": "Anaheim Angels", "value": "ANA"}, {"label": "Arizona Diamondbacks", "value": "ARI"}, {"label": "Atlanta Braves", "value": "ATL"}, {"label": "Baltimore Orioles", "value": "BAL"}, {"label": "Boston Red Sox", "value": "BOS"}, {"label": "Chicago White Sox", "value": "CHA"}, {"label": "Chicago Cubs", "value": "CHN"}, {"label": "Cincinnati Reds", "value": "CIN"}, {"label": "Cleveland Indians", "value": "CLE"}, {"label": "Colorado Rockies", "value": "COL"}, {"label": "Detroit Tigers", "value": "DET"}, {"label": "Florida Marlins", "value": "FLO"}, {"label": "Houston Astros", "value": "HOU"}, {"label": "Kansas City Royals", "value": "KCA"}, {"label": "Los Angeles Dodgers", "value": "LAN"}, {"label": "Milwaukee Brewers", "value": "MIL"}, {"label": "Minnesota Twins", "value": "MIN"}, {"label": "Montreal Expos", "value": "MON"}, {"label": "New York Yankees", "value": "NYA"}, {"label": "New York Mets", "value": "NYN"}, {"label": "Oakland Athletics", "value": "OAK"}, {"label": "Philadelphia Phillies", "value": "PHI"}, {"label": "Pittsburgh Pirates", "value": "PIT"}, {"label": "San Diego Padres", "value": "SDN"}, {"label": "Seattle Mariners", "value": "SEA"}, {"label": "San Francisco Giants", "value": "SFN"}, {"label": "St. Louis Cardinals", "value": "SLN"}, {"label": "Tampa Bay Devil Rays", "value": "TBA"}, {"label": "Texas Rangers", "value": "TEX"}, {"label": "Toronto Blue Jays", "value": "TOR"}], minChars: 1, autoFirst: true, replace: function(suggestion) {this.input.value = suggestion.value; _this.chgTeam();}});
		new Awesomplete(input2, {list: [{"label": "Anaheim Angels", "value": "ANA"}, {"label": "Arizona Diamondbacks", "value": "ARI"}, {"label": "Atlanta Braves", "value": "ATL"}, {"label": "Baltimore Orioles", "value": "BAL"}, {"label": "Boston Red Sox", "value": "BOS"}, {"label": "Chicago White Sox", "value": "CHA"}, {"label": "Chicago Cubs", "value": "CHN"}, {"label": "Cincinnati Reds", "value": "CIN"}, {"label": "Cleveland Indians", "value": "CLE"}, {"label": "Colorado Rockies", "value": "COL"}, {"label": "Detroit Tigers", "value": "DET"}, {"label": "Florida Marlins", "value": "FLO"}, {"label": "Houston Astros", "value": "HOU"}, {"label": "Kansas City Royals", "value": "KCA"}, {"label": "Los Angeles Dodgers", "value": "LAN"}, {"label": "Milwaukee Brewers", "value": "MIL"}, {"label": "Minnesota Twins", "value": "MIN"}, {"label": "Montreal Expos", "value": "MON"}, {"label": "New York Yankees", "value": "NYA"}, {"label": "New York Mets", "value": "NYN"}, {"label": "Oakland Athletics", "value": "OAK"}, {"label": "Philadelphia Phillies", "value": "PHI"}, {"label": "Pittsburgh Pirates", "value": "PIT"}, {"label": "San Diego Padres", "value": "SDN"}, {"label": "Seattle Mariners", "value": "SEA"}, {"label": "San Francisco Giants", "value": "SFN"}, {"label": "St. Louis Cardinals", "value": "SLN"}, {"label": "Tampa Bay Devil Rays", "value": "TBA"}, {"label": "Texas Rangers", "value": "TEX"}, {"label": "Toronto Blue Jays", "value": "TOR"}], minChars: 1, autoFirst: true, replace: function(suggestion) {this.input.value = suggestion.label; _this.chgTeam();}});
		this.boxscores = [];
		this.boxindex = 0;
